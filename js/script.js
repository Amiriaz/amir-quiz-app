let questions = [
        ...
        answer: "Microsoft",
        options: [
          "Apple", "Android", "Google", "Microsoft"
        ]
      },
        {
        numb: 2,
        ...
        options: [
          "Research", "Word Count", "Set language", "Spelling & Grammar"
        ]
      },
      {
        numb: 6,
...
start_btn.onclick = ()=>{
    ...
    const reference = ref(db,'start_btn/')
    set(reference,info_box);//show info box
}
...
window.showQuetions = function (index){
...
window.startTimer = function (time){
...
window.startTimerLine = function (time){
...
window.queCounter = function (index){
